...
public class WebSocketManager {
        ...
        try {
            myWebSocket = new WebSocketClient(new URI(""), myNickName) {
                ...
                public void onError(Exception arg0) {
                    // TODO Auto-generated method stub
                    mConnectStatus = false;
                    // TODO maybe raise a error to test this method
                }
    ...
    public void sendMsg(String room, String msg) {
        ...
        String str = "";
        try {
            str = stringer.object().key(KeyList.METHODNAME).value(KeyList.NORMAL_MESSAGE_ID).key(KeyList.MESSAGE_ROOM)
                    .value(room).key(KeyList.NORMAL_MESSAGE).value(msg).endObject().toString();
