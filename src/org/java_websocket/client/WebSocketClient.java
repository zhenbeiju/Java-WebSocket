...
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable {
    ...
    public WebSocketClient(URI serverURI, String Uname) {
        this(serverURI, new Draft_10(), Uname);
    }
    ...
    public WebSocketClient(URI serverUri, Draft draft, String Uname) {
        this(serverUri, draft, null, 0, Uname);
    }
     ...
     * 从这里去连接服务器
     */
    private final void interruptableRun(String Uname) {
        try {
    ...
    private void sendHandshake(String uName) throws InvalidHandshakeException {
        String path;
