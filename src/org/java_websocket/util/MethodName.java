...
public class MethodName {
    ...
    public static final int GETUSERLIST_ID = 86532575;
    public static final int SETUSERNICKNAME_ID = 32547864;
    ...
    public static String QUITOUT = "QUITOUT";
    public static String GETUSERLIST = "GETUSERLIST";
    public static String SETUSERNICKNAME = "SETUSERNICKNAME";
    public static String SETUSERCLINTID = "SETUSERCLINTID";
