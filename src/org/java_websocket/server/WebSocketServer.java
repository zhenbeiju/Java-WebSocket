...
public abstract class WebSocketServer extends WebSocketAdapter implements Runnable {
    ...
    private HashMap<String, HashSet<WebSocket>> mRooms = new HashMap<String, HashSet<WebSocket>>();
    ...
    public boolean enterIntoROOM(WebSocket ws, String RoomName) {
        try {
            if (mRooms.containsKey(RoomName)) {
                ...
                mRooms.put(RoomName, new HashSet<WebSocket>());
                mRooms.get(RoomName).add(ws);
    ...
    public boolean quitRoom(WebSocket ws, String RoomName) {
